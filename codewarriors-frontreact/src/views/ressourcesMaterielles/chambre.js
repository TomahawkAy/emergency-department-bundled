...
class Chambre extends React.Component {
    ...
    componentWillMount() {
        fetch('http://localhost:3000/chambre')
            ...
            <>
                ...
                <div className="container-fluid" >
                    ...
                    <div className="main">
                        ...
                        <br/>
                        <Col sm="12">
                            <h1 align="center" className="display-4 mb-0">Liste Des Chambres</h1>
                        </Col>
                        <br/>
                                ...
                                {results.map(el => (
                                    <div className="cadreCarte" key={el._id}>
                                        ...
                                        <Card className="card bg-gradient-white text-white"  >
                                            <CardHeader className="text-center" tag="h4"><i className="fas fa-clinic-medical ni-2x"></i> <b>Numéro De Chambre: {el.num_chambre}</b></CardHeader>
                                            <CardBody className="cardBack">
                                                <CardTitle className="text-center" tag="h3"><i
                                                    className="fas fa-cog fa-spin"></i>
                                                    État De Chambre: {el.status_chambre}
                                                </CardTitle>
                                            </CardBody>
