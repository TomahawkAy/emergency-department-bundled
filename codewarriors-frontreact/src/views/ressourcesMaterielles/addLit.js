...
class addLit extends React.Component {
    state = {
        defaultModal: false,
        num_lit : 0,
    };
    ...
    handleSubmit = (e) => {
        ...
        axios.post('http://localhost:3000/lit',this.state).then( response => {
  ...
  <path fill-rule="evenodd" d="M8 15A7 7 0 108 1a7 7 0 000 14zm0 1A8 8 0 108 0a8 8 0 000 16z" clip-rule="evenodd"/>
               ...
               <i className="fa fa-procedures ni-3x"></i>
                        </span>
                                                <span className="btn-inner--text">Gestion Des Lits</span>
                                            </Button>
                                        </div>
                                    </CardHeader>
                                        ...
                                        <Form role="form">
                                            <FormGroup className="mb-3">
                                                <InputGroup className="input-group-alternative">
                                                    ...
                                                    <Input onChange={this.handleChange} placeholder="Numéro de lit" name="num_lit" type="number" />
                                                </InputGroup>
                                            </FormGroup>
...
export default connect(mapStateToProps, actions) (addLit);
